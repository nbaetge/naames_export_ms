...
n.plot <-  processed_export %>% 
  filter(Season == "Late Spring", 
         Target_Z %in% c(0, 5, 10, 25, 50, 75, 100, 150, 200, 300, 400, 500, 750, 1000, 1250, 1500)) %>% 
  ...
  geom_segment(aes(y = redis_N_vol, yend = redis_N_vol, x = 0, xend = 1500, group = Station ), colour = "black", linetype = 2, size = 1.5, alpha = 0.7 ) +
...
doc.plot <-  processed_export %>% 
  ...
  geom_segment(aes(y = redis_DOC_vol, yend = redis_DOC_vol, x = 0, xend = 1500, group = Station ), colour = "black", linetype = 2, size = 1.5, alpha = 0.7 ) +
...
si.plot <-  processed_export %>% 
 ...
 geom_segment(aes( x = Max_MLD, xend = Max_MLD, y = min(ave_Si), yend = max(ave_Si), group = Station ), colour = "#377EB8", linetype = 3, size = 1.5 ) +
  geom_segment(aes(y = redis_Si_vol, yend = redis_Si_vol, x = 0, xend = 1500, group = Station ), colour = "black", linetype = 2, size = 1.5, alpha = 0.7 ) +
